...
# Lista de bancos
BANCOS=("zabbix")
BASE_BACKUP="/backup/zabbix/database/"
...
for DB in "${BANCOS[@]}"; do
    ...
    # Remover todos os arquivos antigos (mantém só o mais recente)
    echo "Removendo backups anteriores do banco $DB..."
